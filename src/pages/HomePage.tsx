  ...
  return (
    <PageContainer maxWidth={1800}>
      <Grid container sx={{ display: "flex", flexDirection: "column", alignItems: "center", spacing: 8 }}>
        ...
        <Typography sx={{ textAlign: "center", maxWidth: 800 }}>
      ...
      <Grid container spacing={1} sx={{ display: "flex", justifyContent: "center", mt: 4, mb: 8 }}>
        <Button
          variant="contained"
          sx={{ width: 135 }}
      ...
      <Grid container spacing={4} sx={{ justifyContent: "center", px: 2 }}>
        {cards.map((x) => (
