...
export function ColorIndicator({ cardPart }: Props) {
  const showIndicator = !!cardPart.colors && cardPart.colors.length > 0;
  ...
  return (
    <Box sx={{
      ...
      width: "0.9em",
      background: color2
        ? `linear-gradient(to bottom right, ${color1.dark} 0%, ${color1.dark} 50%, ${color2.dark} 50%, ${color2.dark} 100%)`
        : color1.dark,
